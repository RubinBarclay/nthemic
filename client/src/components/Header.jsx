...
const Header = ({ playlist, play }) => {
  return (
    <div className="relative flex items-center overflow-hidden h-1/2">
      ...
      <img className="z-10 ml-40 mr-8 bg-red-200 shadow-xl w-72 h-72" src={playlist.albumCoverLG} alt="playlist cover"/> 
      <div className="z-10 text-white">
        ...
        <button 
          ...
          className="px-6 py-3 text-xl bg-transparent border-2 border-gray-200 rounded-full hover:bg-gray-200 hover:text-gray-800 transition-colors whitespace-nowrap">
          Listen now
        </button>
      </div>
    </div>
